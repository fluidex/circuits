...
import { Account, randomMnemonic } from '../../node_modules/fluidex.js/src/account';
...
function initTestCase() {
  ...
  return {
    ...
    sender_balancePathElements: block.balancePathElements[block.balancePathElements.length - 1][0],
    sender_accountPathElements: block.accountPathElements[block.accountPathElements.length - 1][0],
    nonce2: nonce2,
    sign2: account2.sign,
    balance2: balance2,
    ay2: account2.ay,
    ...
    receiver_balancePathElements: block.balancePathElements[block.balancePathElements.length - 1][1],
    receiver_accountPathElements: block.accountPathElements[block.accountPathElements.length - 1][1],
