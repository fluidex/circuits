...
NODE_ARGS="--trace-gc --trace-gc-ignore-scavenger --max-old-space-size=122880 --initial-old-space-size=122880 --no-global-gc-scheduling --no-incremental-marking --max-semi-space-size=1024 --initial-heap-size=122880"
