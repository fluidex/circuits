...
NODE_ARGS="--trace-gc --trace-gc-ignore-scavenger --max-old-space-size=1400000 --initial-old-space-size=1400000 --no-global-gc-scheduling --no-incremental-marking --max-semi-space-size=1024 --initial-heap-size=1400000"
...
~/node/out/Release/node $NODE_ARGS $DIR/../../node_modules/circom/cli.js $CIRCUIT_DIR/circuit.circom -r $CIRCUIT_DIR/circuit.r1cs -c $CIRCUIT_DIR/circuit.c -s $CIRCUIT_DIR/circuit.sym -v
