...
*/
/* This file is copied from iden3's circomlib. The only modification is replacing hash algorithm.
   If circom inmplements generic one day, we can remove this file and use generic */ 
